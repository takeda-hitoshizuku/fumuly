      ...
      <section className="py-16 lg:py-24 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6 lg:gap-8 max-w-2xl mx-auto">
            {/* iOS */}
            <div className="bg-[#F7F8FA] rounded-2xl p-5 lg:p-7">
              <p className="text-xs font-bold text-[#757575] mb-3">iPhone / iPad</p>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="shrink-0 w-6 h-6 bg-[#2C4A7C] text-white text-xs font-bold rounded-full flex items-center justify-center">1</span>
                  <p className="text-sm text-[#2D2D2D]">
                    <span className="font-bold">Safari</span> で fumuly.com を開く
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="shrink-0 w-6 h-6 bg-[#2C4A7C] text-white text-xs font-bold rounded-full flex items-center justify-center">2</span>
                ...
                <div className="flex items-start gap-3">
                  <span className="shrink-0 w-6 h-6 bg-[#2C4A7C] text-white text-xs font-bold rounded-full flex items-center justify-center">3</span>
                  <div className="flex items-center gap-1.5 text-sm text-[#2D2D2D]">
            ...
            <div className="bg-[#F7F8FA] rounded-2xl p-5 lg:p-7">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="shrink-0 w-6 h-6 bg-[#2C4A7C] text-white text-xs font-bold rounded-full flex items-center justify-center">1</span>
                  <p className="text-sm text-[#2D2D2D]">
                    <span className="font-bold">Chrome</span> で fumuly.com を開く
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="shrink-0 w-6 h-6 bg-[#2C4A7C] text-white text-xs font-bold rounded-full flex items-center justify-center">2</span>
